/*
 * socket.h - verbose socket handling functions
 *
 * These functions make use of the debug.h library
 *
 ...
 *
 *
 * In main compilation unit; define SOCKET_IMPLEMENT
 *
 *
...
extern int client_or_server_socket_create(int* sockfd, int* servfd, const char* address, int port, bool debug);
 ...
 *
 * If SOCKET_IMPLEMENT is defined, the definitions will be included
 */

#ifdef SOCKET_IMPLEMENT
 ...
 */
static inline struct sockaddr_in sockaddr_create(int sockfd, const char* address, int port, bool debug)
{
 ...
 */
static inline int socket_bind(int sockfd, const char* address, int port, bool debug)
{
 ...
 */
static inline int socket_listen(int sockfd, int backlog, bool debug)
{
 ...
 */
static inline int socket_create(bool debug)
{
 ...
 */
static inline int server_socket_create(const char* address, int port, bool debug)
{
 ...
 */
static inline int socket_connect(int sockfd, const char* address, int port, bool debug)
{
  struct sockaddr_in addr = sockaddr_create(sockfd, address, port, debug);
 ...
 * -  -1 | Failed to create server socket
 */
static inline int client_socket_create(const char* address, int port, bool debug)
{
 ...
 */
static inline int socket_accept(int servfd, const char* address, int port, bool debug)
{
